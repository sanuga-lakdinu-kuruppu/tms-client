...
- ![Architecture Diagram](./structure/high-level-architecture.png)
- ![Data Model](./structure/data-model.png)
- ![Resource Model (API Endpoints)](./structure/resource-model.png)
- ![User Journey (Figma Jam)](./structure/user-journey.png)
...
- ![Frontend Project Structure](./structure/frontend-proj-structure.png)

## Backend (tms-service)

- ![Backend Project Structure](./structure/backend-proj-structure.png)
