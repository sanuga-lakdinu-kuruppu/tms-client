        ...
        >
          <div className="px-4 sm:px-6 py-4">
            ...
            <div className="mb-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
              ...
              <Link
                href="/tasks/new"
                className="inline-flex justify-center bg-[#030F44] hover:bg-[#0A1A66] text-white text-sm font-medium px-4 py-2 rounded"
              >
                + New Task
              </Link>
            </div>
            ...
            {hasMore && !tasksLoading && (
              <div className="flex justify-center py-4">
                <button
                  ...
                  className="px-4 py-2 text-sm font-medium border border-gray-300 rounded hover:bg-gray-100 disabled:opacity-50"
                >
